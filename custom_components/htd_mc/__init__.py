...
CONFIG_SCHEMA = vol.Schema(
    {
        DOMAIN: vol.Schema(
            [{
                ...
                vol.Optional(CONF_PORT, default=HtdConstants.DEFAULT_HTD_MC_PORT): cv.port,
                ...
                vol.Optional(CONF_RETRY_ATTEMPTS, default=HtdConstants.DEFAULT_RETRY_ATTEMPTS): cv.port,
                vol.Optional(CONF_SOCKET_TIMEOUT, default=HtdConstants.DEFAULT_SOCKET_TIMEOUT): cv.port,
                vol.Optional(CONF_COMMAND_DELAY, default=HtdConstants.DEFAULT_COMMAND_DELAY): cv.port,
            }]
        )
    },
